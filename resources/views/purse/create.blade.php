                    ...
                    <section>
                        ...
                        <form method="post" action="{{route('purse.store')}}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="pin" name="pin" type="number" class="mt-1 block w-full" :value="old('pin')" />
                                <x-input-error class="mt-2" :messages="$errors->get('pin')" />
                            </div>

                            <div>
                                <x-input-label for="currency" :value="__('Currency')" />
                                <x-text-input id="currency" name="currency" type="text" class="mt-1 block w-full" :value="old('currency')" />
