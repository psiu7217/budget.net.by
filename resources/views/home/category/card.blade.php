<section class="space-y-6">
    <header class="border-t py-2 border-gray-100 dark:border-gray-700">
        <a href="{{ route('category.edit', $category->id) }}" class="flex justify-between items-center">
            ...
            <span class="text-gray-400 @if($category->checks->where('created_at', '>', $user->start_date_month)->sum('cash')<= $category->plans->sortByDesc('created_at')->first()->cash) dark:text-gray-200 @else dark:text-red-400 @endif">
